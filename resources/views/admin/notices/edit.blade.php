        ...
        <div class="form_boxs">
            ...
            <div class="form_box">
                ...
                <x-auth-validation-errors class="error" :errors="$errors" /> 
                    <div class="form_list">
                        <label for="name">お知らせタイトル<span class="red">*</span></label><br>
                        <input type="text" id="name" name="name" value="{{ $notice->name }}" placeholder="お知らせタイトル" value="{{ old('name') }}">
                    </div>
                    <div class="form_list">
                        <label for="image">画像<span class="red">*</span></label><br>
                        <input type="file" id="image" name="image" value="{{ $notice->image }}" multiple accept=“image/png,image/jpeg/jpg”>
                    </div>
                    <div class="form_list">
                        <label for="information">店舗について<span class="red">*</span></label><br>
                        <input type="text" id="information" name="information" value="{{ $notice->information }}" placeholder="お知らせ情報" value="{{ old('information') }}">
                    </div>
